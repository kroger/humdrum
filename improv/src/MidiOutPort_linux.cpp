...
//////////////////////////////
//
// MidiOutPort_linux::getChannelOffset --
//
...
//////////////////////////////
//
// MidiOutPort_linux::getPortStatus --
//
...
//////////////////////////////
//
// MidiOutPort_linux::rawsend --
//

int MidiOutPort_linux::rawsend(int command, int p1, int p2) {
   switch (getSelect()) {
      case OSS_MIDI_SELECT:  
         return oss_output->rawsend(command, p1, p2);     
         break;
      case ALSA_MIDI_SELECT: 
         return alsa_output->rawsend(command, p1, p2);    
         break;
      default:               
         return unknown_output->rawsend(command, p1, p2); 
         break;
   }
} 
...
//////////////////////////////
//
// MidiOutPort_linux::setAndOpenPort --
//
...
//////////////////////////////
//
// MidiOutPort_linux::setChannelOffset --
//
...
// md5sum: 04c23292fea5fcd5f5c3f6c08c63389b MidiOutPort_linux.cpp [20050403]
