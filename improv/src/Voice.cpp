...
Voice& Voice::operator=(Voice& aVoice) {
  chan    = aVoice.chan;
  vel     = aVoice.vel;
  key     = aVoice.key;
  oldChan = aVoice.oldChan;
  oldVel  = aVoice.oldVel;
  oldKey  = aVoice.oldKey;
  return *this;
}
...
// md5sum: 746f754b5f7c22b0c706ba05639a9a92 Voice.cpp [20050403]
