...
const char* MidiOutPort_unsupported::getName(void) const {
   ...
   name = new char[strlen(temp.CSTRING)+1];
   strcpy(name, temp.CSTRING);
   return name;
}
...
// md5sum: ee6c7f0b85ac5a4f2c943d9d9947043a MidiOutPort_unsupported.cpp [20030102]
