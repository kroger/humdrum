...
/*
 * Added for CenterPoint/XML, 2000-10-10 <guenter.obiltschnig@cpointc.com>
 *
 * VMS doesn't like identifier names longer than 31 chars,
 * so we map them to shorter names using macros.
 */
 
#if defined(__VMS)
#define XML_SetProcessingInstructionHandler		XML_SetProcessingInstrHndlr
#define XML_SetUnparsedEntityDeclHandler		XML_SetUnparsedEntityDclHndlr
#define XML_SetExternalParsedEntityDeclHandler	XML_SetExtParsedEntityDclHndlr
#define XML_SetInternalParsedEntityDeclHandler	XML_SetIntParsedEntityDclHndlr
#define XML_SetExternalEntityRefHandlerArg		XML_SetExtEntityRefHandlerArg
#endif // defined(__VMS)
